"""Copy-paste helpers for Neuronpedia inference tests.

These helpers are intentionally standalone:
- stdlib
- numpy
- pytest

They are meant to live inside `apps/inference/tests/utils/assertions.py`
or a similar local test utility module.
"""
